...
func (c *Context) GetFunASRPython() string {
	return conf.GetFunASRPython(nil)
}

func (c *Context) GetFunASRScript() string {
	return conf.GetFunASRScript(nil)
}

func (c *Context) GetFunASRTimeoutSec() int {
	return conf.GetFunASRTimeoutSec(nil)
}
